...
function populateSelectYears(e,t,n){if(!e)return!1;var t=t||2e3,n=n||(new Date).getFullYear()+6;select=document.getElementsByClassName(e);for(var a=0;a<select.length;a++)for(var l=t;l<=n;l++){var o=document.createElement("option");o.value=l,o.innerHTML=l,select[a].appendChild(o)}}function makeOptionSelected(e,t){var n=document.getElementById(e);console.log(n);var a=n.getElementsByTagName("option");console.log(a);for(var l=0;l<a.length;l++)a[l].value.toLowerCase()==t.toLowerCase()&&(a[l].selected=!0)}function getSites(e){if(!e)return!1;Site.find(function(t,n){t&&console.error(t);var a=[];n.foreach(function(e){a.push(e.sitename)});for(var l=0;l<a.length;l++){var o=document.createElement("option");o.value=a[l],o.innerHTML=a[l],e.appendChild(o)}})}populateSelectYears("pastAndFutureYearSelect",2e3,(new Date).getFullYear()),populateSelectYears("yearSelect",(new Date).getFullYear()),populateSites("siteSelect");