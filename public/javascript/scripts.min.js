...
function populateSelectYears(e,t,a){if(!e)return!1;var t=t||2e3,a=a||(new Date).getFullYear()+6;select=document.getElementsByClassName(e);for(var i=0;i<select.length;i++)for(var n=t;n<=a;n++){var o=document.createElement("option");o.value=n,o.innerHTML=n,select[i].appendChild(o)}}function makeOptionSelected(e,t){var a=document.getElementById(e);console.log(a);var i=a.getElementsByTagName("option");console.log(i);for(var n=0;n<i.length;n++)i[n].value.toLowerCase()==t.toLowerCase()&&(i[n].selected=!0)}function getSites(e){if(!e)return!1;Site.find(function(t,a){t&&console.error(t);var i=[];a.foreach(function(e){i.push(e.sitename)});for(var n=0;n<i.length;n++){var o=document.createElement("option");o.value=i[n],o.innerHTML=i[n],e.appendChild(o)}})}populateSelectYears("pastAndFutureYearSelect",2e3,(new Date).getFullYear()),populateSelectYears("yearSelect",(new Date).getFullYear()),populateSites("siteSelect"),makeOptionSelected("proposedInternSemesterList","<%= application.proposedinternsemester %>"),makeOptionSelected("proposedInternYearList","<%= application.proposedinternyear %>"),makeOptionSelected("concentrationList","<%= application.major %>"),makeOptionSelected("graduationSemesterList","<%= application.expectedGraduationSemester %>"),makeOptionSelected("graduationYearList","<%= application.expectedGraduationYear %>"),makeOptionSelected("previouslyApplied","<%= application.isPreviouslyApprovedSite %>"),makeOptionSelected("additionalInfoList","<%= application.internsite %>"),makeOptionSelected("preceptorManagerList","<%= application.ispreceptormanager %>"),makeOptionSelected("isStudentEmployedList","<%= application.isstudentemployedatsite %>"),makeOptionSelected("isPaidList","<%= application.ispaidinternship %>"),makeOptionSelected("internquestion","<%= application.isokseperatehours %>"),makeOptionSelected("studentRelationshipList","<%= application.doestudenthavefamilyatsite %>");