...
function populateSelectYears(e,t,a,n){if(!e)return!1;var a=a||2e3,n=n||(new Date).getFullYear()+6;select=document.getElementsByClassName(e);for(var l=0;l<select.length;l++)for(var o=a;o<=n;o++){var r=document.createElement("option");r.value=o,r.innerHTML=o,select[l].appendChild(r)}}function makeOptionSelected(e,t){var a=document.getElementById(e);console.log(a);var n=a.getElementsByTagName("option");console.log(n);for(var l=0;l<n.length;l++)n[l].value.toLowerCase()==t.toLowerCase()&&(n[l].selected=!0)}function getSites(e){if(!e)return!1;Site.find(function(t,a){t&&console.error(t);var n=[];a.foreach(function(e){n.push(e.sitename)});for(var l=0;l<n.length;l++){var o=document.createElement("option");o.value=n[l],o.innerHTML=n[l],e.appendChild(o)}})}populateSelectYears("pastAndFutureYearSelect",2e3,(new Date).getFullYear()),populateSelectYears("yearSelect",(new Date).getFullYear()),populateSelectYears("adminYearSelect",2010),populateSites("siteSelect");