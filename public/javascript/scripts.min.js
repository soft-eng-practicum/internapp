...
function populateSelectYears(e,t,a,l){if(!e)return!1;var a=a||2e3,l=l||(new Date).getFullYear()+6;select=document.getElementsByClassName(e);for(var n=0;n<select.length;n++)for(var o=a;o<=l;o++){var r=document.createElement("option");r.value=o,r.innerHTML=o,select[n].appendChild(r)}}function makeOptionSelected(e,t){var a=document.getElementById(e);console.log(a);var l=a.getElementsByTagName("option");console.log(l);for(var n=0;n<l.length;n++)l[n].value.toLowerCase()==t.toLowerCase()&&(l[n].selected=!0)}function prettySection(e){var t="";switch(e){case"Information Technology Internship (ITEC 4800)":t="ITEC";break;case"Biology Internship (BIO 4800)":t="BIO"}return t}populateSelectYears("pastAndFutureYearSelect",2e3,(new Date).getFullYear()),populateSelectYears("yearSelect",(new Date).getFullYear()),populateSelectYears("adminYearSelect",2010),populateSites("siteSelect");