...
function populateSelectYears(e,t,n){if(!e)return!1;var t=t||2e3,n=n||(new Date).getFullYear()+6;select=document.getElementsByClassName(e);for(var l=0;l<select.length;l++)for(var a=t;a<=n;a++){var o=document.createElement("option");o.value=a,o.innerHTML=a,select[l].appendChild(o)}}function makeOptionSelected(e,t){var n=document.getElementById(e);console.log(n);var l=n.getElementsByTagName("option");console.log(l);for(var a=0;a<l.length;a++)l[a].value==t&&(console.log(t," selected!"),l[a].selected=!0)}function getSites(e){if(!e)return!1;Site.find(function(t,n){t&&console.error(t);var l=[];n.foreach(function(e){l.push(e.sitename)});for(var a=0;a<l.length;a++){var o=document.createElement("option");o.value=l[a],o.innerHTML=l[a],e.appendChild(o)}})}populateSelectYears("pastAndFutureYearSelect",2e3,(new Date).getFullYear()),populateSelectYears("yearSelect",(new Date).getFullYear()),populateSites("siteSelect");