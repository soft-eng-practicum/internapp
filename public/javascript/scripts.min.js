...
function populateSelectYears(e,t,a){if(!e)return!1;var t=t||2e3,a=a||(new Date).getFullYear()+6;select=document.getElementsByClassName(e);for(var n=0;n<select.length;n++)for(var l=t;l<=a;l++){var o=document.createElement("option");o.value=l,o.innerHTML=l,select[n].appendChild(o)}}function makeOptionSelected(e,t){var a=document.getElementById(e);console.log(a);var n=a.getElementsByTagName("option");console.log(n);for(var l=0;l<n.length;l++)n[l].value.toLowerCase()==t.toLowerCase()&&(n[l].selected=!0)}function getSites(e){if(!e)return!1;Site.find(function(t,a){t&&console.error(t);var n=[];a.foreach(function(e){n.push(e.sitename)});for(var l=0;l<n.length;l++){var o=document.createElement("option");o.value=n[l],o.innerHTML=n[l],e.appendChild(o)}})}function test(){console.log("here")}function successSnack(){var e=document.getElementById("snackbarSuccess");e.className="show",setTimeout(function(){e.className=e.className.replace("show","")},5e3)}function failSnack(){var e=document.getElementById("snackbarFailure");e.className="show",setTimeout(function(){e.className=e.className.replace("show","")},5e3)}populateSelectYears("pastAndFutureYearSelect",2e3,(new Date).getFullYear()),populateSelectYears("yearSelect",(new Date).getFullYear()),populateSites("siteSelect");